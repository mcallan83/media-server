...
sudo tee /etc/init/sonarr.conf <<EOF
...
sudo tee /etc/init/jackett.conf <<EOF
...
sudo tee /etc/init/deluge.conf <<EOF
...
sudo tee /etc/init/deluge-web.conf <<EOF
...
sudo tee /etc/init/couchpotato.conf <<EOF
